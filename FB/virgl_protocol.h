...
enum pipe_format {
    ...
    PIPE_FORMAT_R8G8B8A8_SNORM = 6,
    PIPE_FORMAT_R8G8B8A8_UINT = 7,
    PIPE_FORMAT_R8G8B8A8_SINT = 8,
    PIPE_FORMAT_R16G16_FLOAT = 9,
    PIPE_FORMAT_R16G16B16A16_FLOAT = 10,
    PIPE_FORMAT_R16G16_UINT = 11,
    PIPE_FORMAT_R16G16_SINT = 12,
    PIPE_FORMAT_R16G16B16A16_UINT = 13,
    PIPE_FORMAT_R16G16B16A16_SINT = 14,
    PIPE_FORMAT_R16G16_UNORM = 15,
    PIPE_FORMAT_R16G16_SNORM = 16,
    PIPE_FORMAT_R16G16B16A16_UNORM = 17,
    PIPE_FORMAT_R16G16B16A16_SNORM = 18,
    PIPE_FORMAT_R10G10B10A2_UNORM = 19,
    PIPE_FORMAT_R10G10B10A2_UINT = 20,
    PIPE_FORMAT_R11G11B10_FLOAT = 21,
    PIPE_FORMAT_R32G32_UINT = 22,
    PIPE_FORMAT_R32G32B32A32_UINT = 23,
    PIPE_FORMAT_R32G32_SINT = 24,
    PIPE_FORMAT_R32G32B32A32_SINT = 25,
};
